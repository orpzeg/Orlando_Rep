...
def main():
    ...
    for value_dict in final_list:
        value_dict['build_number'] = args.build_number
        value_dict['jobid'] = args.jobid
        value_dict['platform'] = args.platform
        value_dict['is_test'] = args.istest
        value_dict['branch'] = args.branch
